...
export class WeatherCardEditor extends LitElement implements LovelaceCardEditor {
  ...
  private _optionGlobalOptionsEditor(): TemplateResult {
    return html`
      ...
      <div class="side-by-side">
        <ha-select label="Unit System" .configValue=${'unit_system'} .value=${this._unit_system} @closed=${(ev: { stopPropagation: () => any; }) => ev.stopPropagation()} @selected=${this._valueChanged}>
          <mwc-list-item></mwc-list-item>
